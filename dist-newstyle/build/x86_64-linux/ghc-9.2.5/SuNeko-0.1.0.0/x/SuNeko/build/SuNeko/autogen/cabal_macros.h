...
/* package SuNeko-0.1.0.0 */
#ifndef VERSION_SuNeko
#define VERSION_SuNeko "0.1.0.0"
#endif /* VERSION_SuNeko */
#ifndef MIN_VERSION_SuNeko
#define MIN_VERSION_SuNeko(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_SuNeko */
...
#define CURRENT_COMPONENT_ID "SuNeko-0.1.0.0-inplace-SuNeko"
